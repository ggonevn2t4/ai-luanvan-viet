...
-- Create theses table for storing user's thesis data
CREATE TABLE public.theses (
  ...
  content TEXT,
  subject TEXT,
  status TEXT DEFAULT 'draft' CHECK (status IN ('draft', 'completed', 'in_progress')),
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);

-- Enable RLS for theses
...
-- Create trigger for theses timestamp updates
